                                    ...
                                    <form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-6 col-12">
                                                    <label>Nama</label>
                                                    <input name="nama" type="text" class="form-control" value="{{ $ortu->nama ?? '' }}" required>
                                                </div>
                                                <div class="form-group col-md-6 col-12">
                                                    <label>ID</label>
                                                    <input name="ortu_id" type="text" class="form-control" value="{{ $ortu->ortu_id ?? '' }}" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6 col-12">
                                                ...
                                                <div class="form-group col-md-6 col-12">
                                                    <label>No. Telp</label>
                                                    <input name="telp" type="tel" class="form-control" value="{{ $ortu->no_telp ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="row">
                                            <div class="form-group col-12">
