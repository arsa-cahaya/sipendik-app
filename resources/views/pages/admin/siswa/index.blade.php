                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kebutuhan_khusus" name="kebutuhan_khusus" class="form-control @error('kebutuhan_khusus') is-invalid @enderror" placeholder="{{ __('Kebutuhan Khusus') }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
