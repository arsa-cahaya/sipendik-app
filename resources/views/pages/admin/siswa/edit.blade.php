                            ...
                            <form method="POST" action="{{ route('siswa.update', $siswa->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-group ml-4">
                                        ...
                                        <input type="text" id="kebutuhan_khusus" name="kebutuhan_khusus" class="form-control @error('kebutuhan_khusus') is-invalid @enderror" placeholder="{{ __('Kebutuhan Khusus') }}" value="{{ $siswa->kebutuhan_khusus }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
