                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="sampai_jam" id="time2" @error('sampai_jam') is-invalid @enderror" placeholder="{{ __('Jam akhir pelajaran') }}" value="{{ $jadwal->sampai_jam ?? '' }}" />
                            </div>
